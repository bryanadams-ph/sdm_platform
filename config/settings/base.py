...
if READ_DOT_ENV_FILE:
    ...
    # -- on production, we'll pull them from the AWS parameters
    pass
...
# else:
#     DATABASE_URL = "postgres:///sdm_platform"
...
MIGRATION_MODULES = {"sites": "sdm_platform.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "sdm_platform.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""Bryan Adams""", "bryan.adams@perspicacioushealth.com")]
...
ACCOUNT_FORMS = {"signup": "sdm_platform.users.forms.UserSignupForm"}
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Documentation of API endpoints of SDM Platform",
    "VERSION": "1.0.0",
